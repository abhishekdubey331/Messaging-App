...
class MessageListViewModelFactory(private val messageHelper: MessageHelper, private val compositeDisposable: CompositeDisposable, private val scheduler: Scheduler) :
